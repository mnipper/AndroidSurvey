...
Note: Currently this is set to only seed the database if being run in debug mode, and to ignore otherwise.  This is done to hopefully prevent seeding to making into production.  Open to suggestions on how to better do this.
